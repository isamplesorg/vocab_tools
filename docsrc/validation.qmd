...
Vocabulary validation checks the structure of the vocabulary graph by applying SHACL rules using the pySHACL library[^modified]. The SHACL rules are located in `vocab_tools/data` and are included with the code when this package is installed.
