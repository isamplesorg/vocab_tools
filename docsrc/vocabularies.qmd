...
def rdfdot(filenames=None, data=None):
    ...
    if data is not None:
        ...
        for filename in filenames:
            g.parse(filename)
    fp = io.StringIO()
    vocab_tools.rdf2dot2.rdf2dot(g, fp, options=options)
    foo = 2
...
#| echo: false
#| label: fig-minimal
#| fig-cap: 'A minimal vocabulary that defines two concepts "thing" and "solid" within the vocabulary `<https://example.net/my/minimal/vocabulary>`.'
